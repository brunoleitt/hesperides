...
public class PlatformQueries extends AxonQueries {
    ...
    public boolean instanceExists(Platform.Key platformKey, String propertiesPath, String instanceName) {
        return querySync(new InstanceExistsQuery(platformKey, propertiesPath, instanceName), Boolean.class);
    }
    ...
    public List<PlatformPropertiesView> findAllApplicationsProperties() {
        return querySyncList(new FindAllApplicationsPropertiesQuery(), PlatformPropertiesView.class);
    }
